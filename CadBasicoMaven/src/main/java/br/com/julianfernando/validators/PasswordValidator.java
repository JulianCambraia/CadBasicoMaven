...
public class PasswordValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        /*Monta um array de caracteres com o conteúdo da senha e percorre-o contando quantos numeros a senha possui*/
        ...
        /*Monta um array de caracteres com o conteúdo da senha e percorre-o contando quantos caracteres especias a senha possui*/
        for (int i = 0; i < password.length(); i++) {
